...
CREATE TABLE `posts` (
  ...
  CONSTRAINT `fgk_user_id` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `users` (
  ...
  `is_active` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT 'can be only 0 - false or 1 - true, default true',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2019-05-13  8:59:42
